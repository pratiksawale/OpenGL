...
void initialize(void)
{
	...
	void set_color_circle(GLfloat[], int, GLfloat, GLfloat, GLfloat);
	...
	GLfloat circleVertices[301];
	GLfloat circle_color[301];

	Draw_my_Circle(circleVertices,0.0f,0.0f,5.0f);
	set_color_circle(circle_color, sizeof(circle_color)/3, 0.0f, 1.0f, 0.0f);
...
void set_color_circle(GLfloat matrix[], int noOfVertices, GLfloat r, GLfloat g, GLfloat b)
{
	int j = 0;
	for (int i = 0; i < 100; i++)
	{
