...
float gOrthographicProjectionMatrix[16];
...
void initialize(void)
{
	...
	myIdentity(gOrthographicProjectionMatrix);
	resize(WIDTH, HEIGHT);
}
...
void resize(int width, int height)
{
	...
	if (width <= height)
		myOrtho(gOrthographicProjectionMatrix, -100.0f, 100.0f, (-100.0f*(height / width)), (100.0f*(height / width)), -100.0f, 100.0f);
	else
		myOrtho(gOrthographicProjectionMatrix, (-100.0f*(width / height)), (100.0f*(width / height)), -100.0f, 100.0f, -100.0f, 100.0f);
}
...
void display(void)
{
	...
	multiplyMatrices2(modelViewProjectionMatrix, modelViewMatrix, gOrthographicProjectionMatrix);
